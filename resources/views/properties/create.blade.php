                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group propertytitle">
                                            ...
                                            <input type="text" name="propertytitle" class="form-control" id="inputpropertytitle1" placeholder="Titre de la proprieté">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group address">
                                        ...
                                        <input type="text" name="address" class="form-control" id="inputAddress1" placeholder="Pays-Département-Ville/Village-Quartier-Rue-Maison">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-50">
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea name="message" class="form-control" rows="3" placeholder="Minimum 300 caractères"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group phone">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="inputphone1" placeholder="Numéro de téléphone">
                                    </div>
                                </div>
                            </div>
